...
Current validator bounds include 1,500 nodes, 1,500 hierarchy entries, 10,000 edges and 1,000 documents. Browser/model-file input is limited to 15 MiB. Keep reading models considerably smaller for a useful interactive overview.
