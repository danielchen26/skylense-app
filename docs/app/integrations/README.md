...
Skylense supports standard local stdio MCP and a portable skill; host-specific plugin formats differ.
...
The same complete viewer serves generated and agent-authored models. Source content remains data; no repository scripts are run. Agent query results may be sent to the client's model provider. No client settings are modified automatically.
