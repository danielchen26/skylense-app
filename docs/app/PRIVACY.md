...
- Browser files, pasted text, imported JSON and generated models remain in the current page session. Export JSON to keep them. A hosted-app reload restores a bundled example.
